 ...
 *
 * 12-Apr-2017
 * This class is created to wait for angular api requests, jquery requests and
 * js scripts to load and take care of synchronization issues
...
public class JSWaiter {
    ...
    /**
     * @param driver passing the driver to JSWaiter class after driver is initiated
     */
