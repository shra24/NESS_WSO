...
public class DashboardOunce {
	...
	@Test(dataProvider = "getTestData", groups = "Regression", priority = 221)
	public void verifyDashboardStatusOunce(Hashtable<String, String> data, ITestContext context) throws Exception {
